...
- [ ] **RevenueCat** — follow `docs/revenuecat-setup.md`: stores, dashboard, public SDK keys in `.env`, and Terms/Privacy links on the paywall. The app side (crash-proof service, debug mock, admin override) is done.
